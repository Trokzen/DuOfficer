        ...
        RowLayout {
            ...
            Button {
                ...
                onClicked: {
                    ...
                    var startOffset = `${startDaysField.text}:${startHoursField.text}:${startMinutesField.text}:${startSecondsField.text}`;
                    var endOffset = `${endDaysField.text}:${endHoursField.text}:${endMinutesField.text}:${endSecondsField.text}`;
